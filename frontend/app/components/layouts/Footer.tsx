...
export default function Footer() {
  ...
  return (
    <div className="bg-brand text-black dark:text-white h-52 flex flex-col justify-around items-center">
      ...
      <div className = "h-14 border-t border-black dark:border-white w-5/6 flex justify-center items-center">Copyright 2024 © ToolShed Inc. All rights reserved.</div>
    </div>
